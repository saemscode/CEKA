  ...
  public: {
    Tables: {
      ...
      chapters: {
        ...
        Relationships: [
          {
            foreignKeyName: "chapters_lead_id_fkey"
            columns: ["lead_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      generated_articles: {
        ...
        Relationships: [
          {
            foreignKeyName: "generated_articles_model_id_fkey"
            columns: ["model_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "generated_articles_tone_id_fkey"
            columns: ["tone_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "generated_articles_topic_id_fkey"
            columns: ["topic_id"]
            isOneToOne: false
      ...
      chat_interactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "chat_interactions_message_id_fkey"
            columns: ["message_id"]
            isOneToOne: false
      ...
      chat_mentions: {
        Row: {
          created_at: string
          id: string
          mentioned_resource: string | null
      ...
      chat_replies: {
        ...
        Relationships: [
          {
            foreignKeyName: "chat_replies_message_id_fkey"
            columns: ["message_id"]
            isOneToOne: false
            referencedRelation: "chat_messages"
            referencedColumns: ["id"]
      ...
      discussions: {
        ...
        Relationships: [
          {
            foreignKeyName: "discussions_source_message_id_fkey"
      ...
      private_chat_room_members: {
        ...
        Relationships: [
          {
            foreignKeyName: "private_chat_room_members_room_id_fkey"
            columns: ["room_id"]
            isOneToOne: false
