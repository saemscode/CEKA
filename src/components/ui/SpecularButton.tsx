// ============================================================
// FILE: src/components/ui/SpecularButton.tsx
// ============================================================
...
const SpecularButton: React.FC<SpecularButtonProps> = ({
  ...
  const propsRef = useRef<Omit<SpecularButtonProps, 'children' | 'size' | 'tint' | 'tintOpacity' | 'blur' | 'textColor' | 'disabled' | 'onClick' | 'className' | 'type'>>();
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uAngle: { value: 2.4 },
        uPx: { value: dpr },
        uLineColor: { value: [0, 0.4, 0] },
        uBaseColor: { value: [0.56, 0.56, 0.58] },
        uIntensity: { value: 1 },
