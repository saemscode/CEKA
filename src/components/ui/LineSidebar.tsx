...
// ============================================================
import React, { useRef, useState, useCallback, useEffect, MouseEvent, RefObject } from 'react';
import './LineSidebar.css';

type FalloffKey = 'linear' | 'smooth' | 'sharp';
...
const FALLOFF_CURVES: Record<FalloffKey, (p: number) => number> = {
    linear: p => p,
    smooth: p => p * p * (3 - 2 * p),
    sharp: p => p * p * p
};
