        ...
        <div className="border-b">
          <div role="tablist" className="flex">
            <button
              ...
              className={`px-6 py-3 font-medium ${activeTab === 'terms' ? 'text-kenya-green border-b-2 border-kenya-green' : 'text-gray-500'}`}
            ...
            <button
              ...
              className={`px-6 py-3 font-medium ${activeTab === 'privacy' ? 'text-kenya-green border-b-2 border-kenya-green' : 'text-gray-500'}`}
        ...
        >
          {activeTab === 'terms' && (
            <div role="tabpanel" aria-labelledby="terms-tab">
              ...
              <div className="prose prose-sm max-w-none">
                ...
                <h4 className="font-semibold mt-4">1. {translate("Introduction / Agreement to Terms", language)}</h4>
                <p className="text-sm">
                ...
                <h4 className="font-semibold mt-4">2. {translate("Definitions", language)}</h4>
                ...
                <h4 className="font-semibold mt-4">3. {translate("Scope of Services", language)}</h4>
                <p className="text-sm">
                ...
                <h4 className="font-semibold mt-4">4. {translate("Eligibility and Account Registration", language)}</h4>
                <ul className="text-sm list-disc pl-5 space-y-1">
                ...
                <h4 className="font-semibold mt-4">5. {translate("User Conduct and Community Rules", language)}</h4>
                <p className="text-sm">
                ...
                <h4 className="font-semibold mt-4">6. {translate("Content Ownership and License Grants", language)}</h4>
                <p className="text-sm">
                ...
                <h4 className="font-semibold mt-4">7. {translate("Memberships, Donations, and Payments", language)}</h4>
                <p className="text-sm">
                ...
                <h4 className="font-semibold mt-4">8. {translate("Privacy and Data", language)}</h4>
                <p className="text-sm">
                ...
                <h4 className="font-semibold mt-4">9. {translate("Limitation of Liability", language)}</h4>
                <p className="text-sm">
          ...
          {activeTab === 'privacy' && (
            <div role="tabpanel" aria-labelledby="privacy-tab">
              ...
              <div className="prose prose-sm max-w-none">
                <h4 className="font-semibold mt-4">1. {translate("Information We Collect", language)}</h4>
                <p className="text-sm">
                ...
                <h4 className="font-semibold mt-4">2. {translate("How We Use Your Information", language)}</h4>
                <p className="text-sm">
                ...
                <h4 className="font-semibold mt-4">3. {translate("Information Sharing", language)}</h4>
                <p className="text-sm">
                ...
                <h4 className="font-semibold mt-4">4. {translate("Data Security", language)}</h4>
                <p className="text-sm">
                ...
                <h4 className="font-semibold mt-4">5. {translate("Your Rights", language)}</h4>
                <p className="text-sm">
...
// Checkbox component for internal use
