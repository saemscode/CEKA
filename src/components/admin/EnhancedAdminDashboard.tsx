...
const EnhancedAdminDashboard = () => {
    ...
    useEffect(() => {
        ...
        const setupRealtimeSubscriptions = () => {
            // Only setup if component is still mounted
            ...
            try {
                ...
                profilesChannel = supabase
                    ...
                    .subscribe((status) => {
                        console.log('[Dashboard] Profiles channel status:', status);
                    });
                ...
                notificationsChannel = supabase
                    ...
                    .subscribe((status) => {
                        console.log('[Dashboard] Notifications channel status:', status);
                    });
            } catch (error) {
                console.warn('[Dashboard] Failed to setup realtime subscriptions:', error);
            }
        };
        ...
        return () => {
            ...
            // Cleanup subscriptions synchronously
            if (profilesChannel) {
