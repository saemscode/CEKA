...
import { ArrowRight, Users, BookOpen, Vote } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            Empowering Kenyan
            <span className="text-blue-600 block">Citizens</span>
            Through Civic Education
          </h1>
          
          {/* Subtitle */}
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            Your gateway to understanding governance, constitutional rights, and active civic participation in Kenya
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            ...
            <div className="text-center">
              ...
              <div className="text-gray-600">Bills Tracked</div>
            </div>
          </div>
        </div>
      </div>
