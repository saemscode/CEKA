...
// Static chapters data since the table doesn't exist in the database
...
const ChaptersSection = () => {
  // Use static data since the chapters table doesn't exist
  const chapters: Chapter[] = staticChapters;
