...
import { ChatReplies } from '@/components/chat/ChatReplies';
import JoinRoomGuide from '@/components/chat/JoinRoomGuide';
import SidebarPolls from '@/components/chat/SidebarPolls';
import { InteractionLogger } from '@/components/chat/InteractionLogger';
...
const CommunityChat = () => {
  ...
  useEffect(() => {
    if (activeRoom && session) {
      ...
      if (!hasSeenGuide[activeRoom]) setShowGuide(true);
    }
  }, [activeRoom, session, fetchMessages, fetchModerationStatus, hasSeenGuide]);
