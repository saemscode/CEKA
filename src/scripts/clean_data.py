...
def clean_facility_data():
    ...
    if 'allocation_period' in df.columns:
        def clean_allocation_period(period):
            ...
            if 'q1' in period or 'quarter 1' in period:
                return "Q1"
            elif 'q2' in period or 'quarter 2' in period:
                return "Q2"
            elif 'q3' in period or 'quarter 3' in period:
                return "Q3"
            elif 'q4' in period or 'quarter 4' in period:
                return "Q4"
