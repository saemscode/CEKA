...
class NotificationService {
  ...
  /**
   * Universal notification subscriber
   */
  async subscribeToNotifications(
            ...
            onNotification: (notification: any) => void
              ...
              try {
                // Clean up any existing channel with same name to avoid leaks
                const channelName = `public:notifications:user:${userId}`;
                // Attempt to remove existing channel if it exists, to ensure a clean slate
      ...
      const channel = supabase
                  ...
                  .on(
                    'postgres_changes',
                    {
                      event: 'INSERT',
                      schema: 'public',
                      table: 'user_notifications', // Assuming 'user_notifications' is the correct table for real-time updates
