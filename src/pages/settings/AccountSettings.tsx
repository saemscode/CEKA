          ...
          <CardContent className="space-y-4">
            <div className="grid gap-4">
              <div className="grid gap-2">
                <Input id="name" name="full_name" placeholder={translate("Your name", language)} defaultValue={session?.user?.user_metadata?.full_name || ""} />
              </div>
              <div className="grid gap-2">
                <Input id="email" name="email" type="email" placeholder="you@example.com" defaultValue={session?.user?.email || ""} disabled />
              </div>
            </div>
