...
const SECTIONS: AboutSection[] = [
    ...
    },
    {
        ...
        description: 'A secure document vault powered by Backblaze B2 with authenticated access, signed URLs, and audit logging for every civic resource.',
        longDescription: 'The Resource Vault provides authenticated access to legislative PDFs, NCEF documents, guides, and civic education materials. Documents are stored on Backblaze B2 (S3-compatible) and accessed via time-limited signed URLs generated by the vault-auth Edge Function. Every access is audit-logged with user ID, email, file path, and request duration.',
        icon: Lock,
        features: [
...
const PartnerSection = () => {
    ...
    const partnerships = [
        ...
        { title: 'Content Co-creation', desc: 'Jointly produce bilingual educational materials for the Resource Vault.' },
    ];
