        ...
        <section className="pt-28 pb-12 safe-area">
          <div className="container mx-auto px-4">
            ...
            <div className="mt-10 mb-12 grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-white/40 dark:bg-gradient-to-br dark:from-ios-blue/20 dark:via-ios-blue/10 dark:to-transparent backdrop-blur-xl border border-white/30 dark:border-border shadow-lg shadow-black/20 dark:shadow-sm rounded-2xl p-4 text-center">
