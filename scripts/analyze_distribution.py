...
def analyze_facility_distribution(csv_url=None):
    """Analyze facility distribution from a URL or local file"""
    ...
    if 'latitude' in df.columns and 'longitude' in df.columns:
        ...
        if len(geo_df) > 10:  # Only cluster if we have enough points
            ...
            # Plot clusters
            plt.figure(figsize=(12, 8))
            scatter = plt.scatter(geo_df['longitude'], geo_df['latitude'], c=geo_df['cluster'], cmap='viridis', alpha=0.6)
...
if __name__ == "__main__":
    ...
    # analyze_facility_distribution("https://example.com/facilities_cleaned.csv")
