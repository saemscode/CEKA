...
def generate_report(csv_url=None):
    """Generate analysis report from a URL or local file"""
...
if __name__ == "__main__":
    ...
    # Or with local file:
    generate_report("https://www.civiceducationkenya.com/shambles/facilities_cleaned.csv")
