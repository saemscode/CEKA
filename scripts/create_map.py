...
def create_facility_map(csv_url=None):
    """Create a map of healthcare facilities from a URL or local file"""
    ...
    type_colors = {
        'Hospital': 'red', 'Health Center': 'blue', 'Dispensary': 'green',
        'Clinic': 'purple', 'Pharmacy': 'orange', 'Laboratory': 'gray',
        'Other': 'black'
    }
    ...
    # Add legend
    legend_html = '''
    <div style="position: fixed; bottom: 50px; left: 50px; width: 150px; height: 180px; 
...
if __name__ == "__main__":
    ...
    # create_facility_map("https://example.com/facilities_cleaned.csv")
