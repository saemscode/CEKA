  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        // IEBC Office Finder Animations from Nasaka
        'pulse-ring': {
          '0%': {
            transform: 'scale(0.9)',
            opacity: '1'
      ...
      fontFamily: {
        // Extended font families from Nasaka
        'sans': ['-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Helvetica Neue', 'Arial', 'sans-serif'],
        'system': ['-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Helvetica Neue', 'Arial', 'sans-serif']
      },
      fontSize: {
        // Extended font sizes from Nasaka
      ...
      backgroundImage: {
        // Extended background images from Nasaka
      ...
      gridTemplateColumns: {
        // Extended grid templates from Nasaka
        'auto-fit': 'repeat(auto-fit, minmax(250px, 1fr))',
        'auto-fill': 'repeat(auto-fill, minmax(250px, 1fr))'
      },
      transitionProperty: {
        // Extended transition properties from Nasaka
        'height': 'height',
        'spacing': 'margin, padding',
        'size': 'width, height'
      },
      transitionDuration: {
        // Extended transition durations from Nasaka
        '400': '400ms',
        '600': '600ms',
        '800': '800ms'
      },
      zIndex: {
        // Z-index values from CEKA
        '60': '60',
        '70': '70',
        '80': '80',
        '90': '90',
